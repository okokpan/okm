...
class __TwigTemplate_2fb82d765888f28a81e9a9f55b45abc9188a292c1da0bf18285290934fa12cd8 extends Twig_SupTwg_Template
{
...
\t\t\t<i class=\"fa fa-list-alt\"></i>";
        // line 31
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Registration Fields")), "html", null, true);
        echo "
\t\t</a>
\t\t";
        // line 34
...
";
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"";
        // line 42
        echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->getAssetsPath("base", "lib/cropper/cropper.min.css"), "html", null, true);
        echo "\">
    <script async type=\"text/javascript\" src=\"";
        // line 43
        echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->getAssetsPath("base", "lib/cropper/cropper.min.js"), "html", null, true);
        echo "\"></script>
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["value"] => $context["role"]) {
            // line 64
            echo "\t\t\t\t\t\t";
            $context["_roles"] = Twig_SupTwg_array_merge(($context["_roles"] ?? null), array(0 => array("title" => $this->getAttribute(            // line 65
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 121
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 125
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 140
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-large-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 144
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-large-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 159
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-medium-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 163
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-medium-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 178
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-small-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 182
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "avatar-small-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\tsrc=\"";
        // line 200
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar", array(), "array"), "html", null, true);
        echo "\"
\t\t\t\t\t\t\t\t\t>
\t\t\t\t\t\t\t\t\t<button class=\"mp-option-button sc-button primary mp-change\">";
        // line 202
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Change")), "html", null, true);
        echo "</button>
...
\t\t\t\t\t\t\t\t\t\t";
        ...
        // line 207
        echo "\t\t\t\t\t\t\t\t\t>";
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Set to default")), "html", null, true);
        echo "</button>
\t\t\t\t\t\t\t\t\t<input
\t\t\t\t\t\t\t\t\t\ttype=\"hidden\"
\t\t\t\t\t\t\t\t\t\tname=\"default-avatar\"
...
\t\t\t\t\t\t\t\t\t>
                                    <input
                                            ...
                                            value=\"";
        // line 216
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar-large", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            value=\"";
        // line 221
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar-medium", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            value=\"";
        // line 226
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar-small", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            data-default-image=\"";
        // line 234
        echo Twig_SupTwg_escape_filter($this->env, ($context["defaultAvatar"] ?? null), "html", null, true);
        echo "\"
                                            value=\"";
        // line 235
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar-source", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            value=\"";
        // line 240
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-avatar-crop-data", array(), "array"), "html", null, true);
        echo "\"
                                    >
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 273
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 277
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 292
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-medium-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 296
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-medium-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 311
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-small-size", array(), "array"), "width", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t<input class=\"sc-input\" value=\"";
        // line 315
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["settings"] ?? null), "cover-small-size", array(), "array"), "height", array()), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\tsrc=\"";
        // line 332
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-cover", array(), "array"), "html", null, true);
        echo "\"
\t\t\t\t\t\t\t\t\t>
\t\t\t\t\t\t\t\t\t<button class=\"mp-option-button sc-button primary mp-change\">";
        // line 334
...
\t\t\t\t\t\t\t\t\t>
                                    <input
                                            ...
                                            value=\"";
        // line 348
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-cover-medium", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            value=\"";
        // line 353
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-cover-small", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            data-default-image=\"";
        // line 358
        echo Twig_SupTwg_escape_filter($this->env, ($context["defaultCover"] ?? null), "html", null, true);
        echo "\"
                                            ...
                                            value=\"";
        // line 362
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-cover-source", array(), "array"), "html", null, true);
        echo "\"
                                    >
                                    <input
                                            type=\"hidden\"
                                            ...
                                            value=\"";
        // line 367
        echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "default-cover-crop-data", array(), "array"), "html", null, true);
        echo "\"
                                    >
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t<span>";
        // line 465
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Save Fields")), "html", null, true);
        echo "</span>
\t\t\t\t\t\t\t</button>
...
\t\t\t\t\t\t\t\t<span>";
        // line 469
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Add Section")), "html", null, true);
        echo "</span>
\t\t\t\t\t\t\t</button>
...
\t\t\t\t\t\t\t\t<span>";
        // line 473
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Add Field")), "html", null, true);
        echo "</span>
\t\t\t\t\t\t\t</button>
\t\t\t\t\t\t</div>
...
\t\t\t\t<label class=\"sc-label\">";
        // line 566
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Section Name")), "html", null, true);
        echo "</label>
\t\t\t</div>
\t\t\t<div class=\"col-md-8\">
...
\t\t\t\t";
        // line 578
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("This is protected field. You cannot modify its type.")), "html", null, true);
        echo "
\t\t\t</div>
...
\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 584
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Label")), "html", null, true);
        echo "</label>
...
\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 589
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Section")), "html", null, true);
        echo "</label>
...
\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 601
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Description")), "html", null, true);
        echo "</label>
...
\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 611
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Date Format")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t<select class=\"sc-input field-date-format\" name=\"date-format\">
\t\t\t\t\t\t\t\t";
        // line 613
        $context['_parent'] = $context;
        $context['_seq'] = Twig_SupTwg_ensure_traversable(($context["dateFormats"] ?? null));
        foreach ($context['_seq'] as $context["value"] => $context["data"]) {
            // line 614
            echo "\t\t\t\t\t\t\t\t\t<option value=\"";
            echo Twig_SupTwg_escape_filter($this->env, $context["value"], "html", null, true);
            echo "\">";
            echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($context["data"], "text", array()), "html", null, true);
            echo "</option>
\t\t\t\t\t\t\t\t";
        }
        $_parent = $context['_parent'];
...
\t\t\t\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 629
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Google ReCaptcha Site Key")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td class=\"mp-field-option-setting\">
...
\t\t\t\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 645
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Google ReCaptcha Secret Key")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td class=\"mp-field-option-setting\">
\t\t\t\t\t\t\t\t\t\t<div class=\"mp-option-helper tooltip\">
...
\t\t\t\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 661
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Google ReCaptcha Theme")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td class=\"mp-field-option-setting\">
\t\t\t\t\t\t\t\t\t\t<div class=\"mp-option-helper tooltip\">
...
\t\t\t\t\t\t\t\t\t\t\t<option value=\"light\">";
        // line 673
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Light")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t\t<option value=\"dark\">";
        // line 674
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Dark")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 680
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Google ReCaptcha Type")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td class=\"mp-field-option-setting\">
\t\t\t\t\t\t\t\t\t\t<div class=\"mp-option-helper tooltip\">
...
\t\t\t\t\t\t\t\t\t\t\t<option value=\"audio\">";
        // line 692
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Audio")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t\t<option value=\"image\" selected=\"true\">";
        // line 693
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Image")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 699
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Google ReCaptcha Size")), "html", null, true);
        echo "</label>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t<td class=\"mp-field-option-setting\">
\t\t\t\t\t\t\t\t\t\t<div class=\"mp-option-helper tooltip\">
...
\t\t\t\t\t\t\t\t\t\t\t<option value=\"compact\">";
        // line 711
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Compact")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t\t<option value=\"normal\" selected=\"true\">";
        // line 712
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Normal")), "html", null, true);
        echo "</option>
\t\t\t\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t</tr>
...
\t\t\t\t\t\t";
        // line 727
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Registration")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t\t\t\t\t\t";
        // line 734
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Required")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
                <div class=\"col-md-3\">
                    <label class=\"sc-checkbox\">
                        ...
                        ";
        // line 741
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Asterisk")), "html", null, true);
        echo "
                        <div class=\"sc-checkbox-state\"></div>
                    </label>
                </div>
...
\t\t\t\t\t\t";
        // line 748
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Enabled")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t\t\t\t\t\t<input type=\"checkbox\" name=\"addNone\" value=\"true\" id=\"popup-addNone\">
                        ";
        // line 755
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Add None")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t\t\t\t\t\t<input type=\"checkbox\" name=\"ipSelection\" value=\"true\" id=\"popup-ipSelection\">
                        ";
        // line 762
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Country selection by IP")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t\t\t\t\t\t<input type=\"checkbox\" name=\"hideInProfile\" value=\"true\" id=\"popup-hideInProfile\">
                        ";
        // line 769
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Hide in profile")), "html", null, true);
        echo "
\t\t\t\t\t\t<div class=\"sc-checkbox-state\"></div>
\t\t\t\t\t</label>
\t\t\t\t</div>
...
\t\t\t\t\t\t<label class=\"sc-label\">";
        // line 779
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Option Name")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-6\">
\t\t\t\t\t\t<div class=\"sc-input-row\">
...
\t\t\t\t\t\t\t\t";
        // line 814
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Default Selected")), "html", null, true);
        echo "
...
\t\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t\t<label class=\"sc-label\" for=\"validation-min_size\">";
        // line 830
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Minimum length")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-8\">
\t\t\t\t\t\t<div class=\"sc-input-row\">
...
\t\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t\t<label class=\"sc-label\" for=\"validation-max_size\">";
        // line 842
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Maximum length")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-8\">
\t\t\t\t\t\t<div class=\"sc-input-row\">
...
\t\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t\t<label class=\"sc-label\" for=\"validation-digits\">";
        // line 854
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Only numbers")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-8\">
\t\t\t\t\t\t<label class=\"sc-checkbox\">
...
\t\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t\t<label class=\"sc-label\" for=\"validation-alpha\">";
        // line 866
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Only letters")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-8\">
\t\t\t\t\t\t<label class=\"sc-checkbox\">
...
\t\t\t\t\t<div class=\"col-md-4\">
\t\t\t\t\t\t<label class=\"sc-label\" for=\"validation-pattern\">";
        // line 878
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Validation Pattern")), "html", null, true);
        echo "</label>
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-8\">
\t\t\t\t\t\t<div class=\"sc-input-row\">
...
";
    ...
    public function getfieldsList(...$__varargs__)
    {
        ...
        try {
            ...
            echo "\t";
            $context['_parent'] = $context;
            $context['_seq'] = Twig_SupTwg_ensure_traversable(($context["fields"] ?? null));
...
\t";
    ...
    {
        return new Twig_SupTwg_Source("", "@users/backend/index.twig", "/www/www.wonways.com/wp-content/plugins/membership-by-supsystic/src/Membership/Users/views/backend/index.twig");
    }
}
