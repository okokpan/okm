...
class __TwigTemplate_1df5aeb3d88f716c4dbd409c478e3faac6171cd1e1156c228f870d4856acce3e extends Twig_SupTwg_Template
{
...
\t\t\t\t<span title=\"";
            // line 6
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Contact Us")), "html", null, true);
            echo "\">";
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Contact Us")), "html", null, true);
            echo "</span>
\t\t\t</div>
...
\t\t\t\t\t\t<option value=\"\">";
            // line 39
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Select value")), "html", null, true);
            echo "</option>
\t\t\t\t\t\t";
            // line 40
            $context['_parent'] = $context;
            $context['_seq'] = Twig_SupTwg_ensure_traversable(($context["contactFormPresets"] ?? null));
            foreach ($context['_seq'] as $context["_key"] => $context["val1"]) {
                ...
                echo ">";
                echo Twig_SupTwg_escape_filter($this->env, $this->getAttribute($context["val1"], "label", array()), "html", null, true);
                echo "</option>
\t\t\t\t\t\t";
            }
...
\t\t\t\t";
            // line 57
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("You have no Contact Form for now. Create your Contact Form or Enable Membership feature for contact form which you want to use for Contact Us page.")), "html", null, true);
            echo "
\t\t\t</div>
\t\t</div>
\t</div>
...
\t\t\t\t";
            // line 70
            echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("You need to install Contact Form by Supsystic to use this feature. ")), "html", null, true);
            echo "
\t\t\t\t<a target=\"_blank\" href=\"";
            // line 71
            echo Twig_SupTwg_escape_filter($this->env, ($context["pluginInstallUrl"] ?? null), "html", null, true);
            echo "\">";
...
\t\t\t\t<a target=\"_blank\" href=\"";
            // line 73
            echo Twig_SupTwg_escape_filter($this->env, ($context["wpPluginInstallUrl"] ?? null), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return new Twig_SupTwg_Source("", "@contactform/partials/backend.main.page.contact.form.twig", "/www/www.wonways.com/wp-content/plugins/membership-by-supsystic/src/Membership/ContactForm/views/partials/backend.main.page.contact.form.twig");
    }
}
