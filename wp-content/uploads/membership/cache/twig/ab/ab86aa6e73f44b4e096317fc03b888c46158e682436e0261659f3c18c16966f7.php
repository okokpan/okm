...
class __TwigTemplate_fc95c02f6b2bb1e8e207d77fcf579cca9906cdc9498e857bdc2a54e0f7df3bc4 extends Twig_SupTwg_Template
{
...
\t";
            // line 3
            $context["page"] = (($this->getAttribute(($context["settings"] ?? null), "page", array())) ? (Twig_SupTwg_number_format_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "page", array()))) : (1));
            // line 4
            echo "\t";
            $context["totalPages"] = (($this->getAttribute(($context["settings"] ?? null), "totalPages", array())) ? (Twig_SupTwg_number_format_filter($this->env, $this->getAttribute(($context["settings"] ?? null), "totalPages", array()))) : (1));
            // line 5
            echo "\t";
...
\t\t\t";
                ...
                if (((($context["page"] ?? null) > 1) && (($context["totalPages"] ?? null) > 1))) {
                    // line 15
                    echo "\t\t\t\t<a href=\"";
                    echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->dashboardUrl($this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "module", array()), $this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "action", array()), Twig_SupTwg_array_merge(array("p" => 1), ($context["queryParams"] ?? null))), "html", null, true);
                    echo Twig_SupTwg_escape_filter($this->env, ($context["hash"] ?? null), "html", null, true);
                    echo "\">";
...
\t\t\t\t<a href=\"";
                    // line 16
                    echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->dashboardUrl($this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "module", array()), $this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "action", array()), Twig_SupTwg_array_merge(array("p" => (($context["page"] ?? null) - 1)), ($context["queryParams"] ?? null))), "html", null, true);
                    echo Twig_SupTwg_escape_filter($this->env, ($context["hash"] ?? null), "html", null, true);
                    echo "\">";
...
\t\t\t";
                ...
                $context['_seq'] = Twig_SupTwg_ensure_traversable(range(($context["minRangePage"] ?? null), ($context["maxRangePage"] ?? null)));
                $context['loop'] = array(
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["rangePage"]) {
                    ...
                    if ((((($context["page"] ?? null) == $context["rangePage"]) || ((($context["page"] ?? null) == ($context["minRangePage"] ?? null)) && $this->getAttribute($context["loop"], "first", array()))) || ((($context["page"] ?? null) == ($context["maxRangePage"] ?? null)) && $this->getAttribute($context["loop"], "last", array())))) {
                        ...
                        echo Twig_SupTwg_escape_filter($this->env, $context["rangePage"], "html", null, true);
                        echo "</b></span>
\t\t\t\t";
                    } else {
                        // line 22
                        echo "\t\t\t\t\t<a href=\"";
                        echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->dashboardUrl($this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "module", array()), $this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "action", array()), Twig_SupTwg_array_merge(array("p" => $context["rangePage"]), ($context["queryParams"] ?? null))), "html", null, true);
                        echo Twig_SupTwg_escape_filter($this->env, ($context["hash"] ?? null), "html", null, true);
                        echo "\" >";
                        echo Twig_SupTwg_escape_filter($this->env, $context["rangePage"], "html", null, true);
                        echo "</a>
...
\t\t\t\t<a href=\"";
                    // line 27
                    echo Twig_SupTwg_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->dashboardUrl($this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "module", array()), $this->getAttribute($this->getAttribute(($context["request"] ?? null), "query", array()), "action", array()), Twig_SupTwg_array_merge(array("p" => ($context["totalPages"] ?? null)), ($context["queryParams"] ?? null))), "html", null, true);
                    echo Twig_SupTwg_escape_filter($this->env, ($context["hash"] ?? null), "html", null, true);
                    echo "\">";
...
";
    ...
    {
        return new Twig_SupTwg_Source("", "@base/macros/pagination.twig", "/www/www.wonways.com/wp-content/plugins/membership-by-supsystic/src/Membership/Base/views/macros/pagination.twig");
    }
}
