...
/* @promo/promo.twig */
class __TwigTemplate_78c0b32870a5860b35b7c343d5ca10efa105b6d8e189f2a0a128709b0fd03f03 extends Twig_SupTwg_Template
{
    ...
    <div class=\"container-fluid\" style=\"background: white; margin: 1.4em; padding: 1em 3em 3em; font-size: 1.3em\">
        <div class=\"row\">
            <div class=\"col-sm-12\">
                <h2 class=\"header\">";
        // line 6
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Welcome to the")), "html", null, true);
        echo " ";
        ...
        echo "</h2>
                <p>";
        // line 7
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Thank you for choosing our plugin! We are happy you like Membership plugin by Supsystic and You will get our best work!")), "html", null, true);
        echo "</p>
                <p>";
        // line 8
            ...
            <div class=\"col-sm-12\">
                <div class=\"row\">
                    <div class=\"col-sm-6\">
                        <h3>";
        // line 16
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("A small guide for the first-time user")), "html", null, true);
        echo "</h3>
                         <p>";
        // line 17
...
\t                    </div>
                    ...
                    <div class=\"col-sm-6\">
                        <h3>";
        // line 27
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Support part")), "html", null, true);
        echo "</h3>
                        <p>";
        // line 28
        ...
        echo " </li>
                        ...
                        <p>";
        // line 33
        echo Twig_SupTwg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Feel free to contact us and don't worry, everything will be cool!")), "html", null, true);
        echo "</p>
\t                    <a href=\"";
        // line 34
...
";
    ...
    {
        return new Twig_SupTwg_Source("", "@promo/promo.twig", "/www/www.wonways.com/wp-content/plugins/membership-by-supsystic/src/Membership/Promo/views/promo.twig");
    }
}
